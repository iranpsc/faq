<template>
    <div
        ...
        <!-- User Avatar -->
        <div class="mb-3">
            <BaseAvatar :src="user.image_url" :name="user.name" size="2xl" class="mx-auto" />
        </div>
        ...
        <div class="flex justify-center mb-4">
            <span
                class="inline-flex items-center px-3 py-1 pt-[5px] rounded-full  text-gray-800 dark:text-gray-200 text-sm font-bold border border-gray-300 dark:border-gray-500">
                <span class=" font-normal text-xs md:text-sm">{{ formatNumber(user.score) }} : </span>
                <span class=" text-xs md:text-sm font-normal">امتیاز</span>
            </span>
        </div>
        ...
        <!-- Answers Count -->
        <div class="mb-2 flex gap-[6px] items-center mx-auto">
            <svg class="inline w-5 h-5  text-blue-500 dark:text-yellow-400 " fill="currentColor" viewBox="0 0 20 20">
                <path
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 font-semibold">پاسخ داده شده : </span>
        ...
        <!-- Comments Count -->
        <div class="mb-4 flex gap-[6px] items-center mx-auto">
            <svg class="inline w-5 h-5  text-green-500 dark:text-yellow-400 mr-1" fill="currentColor"
                viewBox="0 0 20 20">
                <path
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 font-semibold">نظر داده شده : </span>
            <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">
