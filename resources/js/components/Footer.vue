<template>
    <footer class=" py-8 mb-0 pb-0 px-4 md:px-7 transition-colors duration-300 space-y-6">
        ...
        <div class="flex-wrap flex justify-center items-center gap-2 mx-auto p-4 rounded-3xl bg-gray-100 dark:bg-gray-800 w-full">
            ...
            <a class="active" href="#" target="_blank " style="width:55px; height:55px;" title="نماد اعتماد الکترونیک">
            ...
            <a href="https://irpsc.com" target="_blank " style="width:55px; height:55px;" title="ثبت اسناد و املاک کشور">
            ...
            <a href="https://video.irpsc.com" target="_blank " style="width:55px; height:55px;" title="مرکز آموزش ویدئویی">
            ...
            <a href="https://faq.irpsc.com" target="_blank " style="width:55px; height:55px;" title="انجمن پرسش و پاسخ">
            ...
            <a href="https://Shop.irpsc.com" target="_blank " style="width:55px; height:55px;" title="فروشگاه ملی">
            ...
            <a href="https://supply.irpsc.com" target="_blank " style="width:55px; height:55px;" title="تولید کنندگان">
            ...
            <a href="https://crm.irpsc.com" target="_blank " style="width:55px; height:55px;" title="مدیریت بر مدیران">
            ...
            <a href="https://target.irpsc.com" target="_blank " style="width:55px; height:55px;" title="نگرش ملی">
            ...
            <a href="https://animal.irpsc.com" target="_blank " style="width:55px; height:55px;" title="حیوانات و دامپزشک">
            ...
            <a href="https://irpsc.com" target="_blank " style="width:55px; height:55px;" title="رسانه ملی">
            ...
            <a href="https://meta.irpsc.com" target="_blank " style="width:55px; height:55px;" title="اخبار متا">
            ...
            <a href="https://uni.irpsc.com" target="_blank " style="width:55px; height:55px;" title="دانشگاه متاورس">
            ...
            <a href="https://crm.irpsc.com/knowledgebase" target="_blank " style="width:55px; height:55px;"
            ...
            <a href="https://sale.irpsc.com" target="_blank " style="width:55px; height:55px;" title="فروشگاه مجازی حم">
            ...
            <a href="https://ad.irpsc.com" target="_blank " style="width:55px; height:55px;" title="تبلیغات ملی">
            ...
            <a href="https://nft.irpsc.com" target="_blank " style="width:55px; height:55px;" title="بازار NFT">
            ...
            <a href="https://rgb.irpsc.com" target="_blank " style="width:55px; height:55px;" title="متاورس رنگ">
            ...
            <a href="https://rgb.irpsc.com" target="_blank " style="width:55px; height:55px;" title="سه بعدی متا">
        ...
        <div class=" mx-auto ">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <BaseCard variant="shadow" rounded="3xl" padding="lg"
                    class="bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white text-center relative overflow-hidden">
                    <!-- Background decoration -->
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-transparent"></div>
                    <div class="relative z-10 py-6 flex flex-col md:flex-row md:items-center md:justify-between md:text-right text-center">
                        <div class="md:mb-0 mb-6 md:mr-4 flex-1">
                            <h3 class="text-3xl font-bold mb-4 text-white">پرسیدن سوال</h3>
                            <p class="text-blue-100 dark:text-blue-200 text-lg leading-relaxed">هر سوالی که بخوای میتونی بپرسی...</p>
                        </div>
                        <div class="flex items-center justify-center md:justify-end flex-shrink-0">
                            <BaseButton variant="outline" size="lg" rounded="xl"
                                class="bg-white/95 text-blue-600 dark:text-blue-700 border-white/90 hover:bg-white hover:shadow-lg transition-all duration-300 font-semibold px-12 py-4 text-lg"
                ...
                <BaseCard variant="shadow" rounded="3xl" padding="lg"
                    class="bg-gradient-to-br from-green-400 to-green-600 dark:from-green-500 dark:to-green-700 text-white text-center relative overflow-hidden">
                    <!-- Background decoration -->
                    <div class="absolute inset-0 bg-gradient-to-br from-green-300/20 to-transparent"></div>
                    <div class="relative z-10 py-6 flex flex-col md:flex-row md:items-center md:justify-between md:text-right text-center">
                        <div class="md:mb-0 mb-6 md:mr-4 flex-1">
                            <h3 class="text-2xl font-bold mb-4 text-white">نحوه امتیازدهی</h3>
                            <p class="text-green-50 dark:text-green-100 text-sm leading-relaxed">راهنمای چگونگی
                                امتیازدهی به شهروندان</p>
                        </div>
                        <div class="flex items-center justify-center md:justify-end flex-shrink-0">
                            <BaseButton variant="outline" size="lg" rounded="xl"
                                class="bg-white/95 text-green-600 dark:text-green-700 border-white/90 hover:bg-white hover:shadow-lg transition-all duration-300 font-semibold px-8 py-3"
                                @click="handleScoring">
                                امتیاز
                            </BaseButton>
                        </div>
        ...
        <div class="bg-gray-200 dark:bg-gray-700 py-6  rounded-t-3xl mb-0 transition-colors duration-300">
            <div class="container mx-auto px-4">
                ...
                <div class="flex justify-center items-center gap-4 mb-4">
                    <a href="#"
                        class="w-10 h-10 bg-red-500 rounded-full flex items-center justify-center hover:bg-red-600 transition-colors">
                    ...
                    <a href="#"
                        class="w-10 h-10 bg-gray-500 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="#"
                        class="w-10 h-10 bg-pink-500 rounded-full flex items-center justify-center hover:bg-pink-600 transition-colors">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.174-.105-.949-.199-2.403.042-3.441.219-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.888-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.357-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24.009 12.017 24c6.624 0 11.99-5.367 11.99-11.988C24.007 5.367 18.641.001.012.001z" />
                        </svg>
...
@media (max-width: 768px) {
    ...
    .gap-4.flex-wrap .w-16.h-16 {
        width: 3rem;
        height: 3rem;
    }

    .gap-4.flex-wrap .w-16.h-16 svg {
        width: 1.5rem;
        height: 1.5rem;
    }
}
