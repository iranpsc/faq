  ...
  <main class="flex-grow p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-gray-900/50 overflow-y-auto">
    <div class="max-w-4xl mx-auto">
      ...
      <div v-else-if="question && question.id">
        <!-- Updating Indicator -->
        <div v-if="isUpdating" class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4 flex items-center gap-3">
        ...
        <CommentsSection
          ...
          @comment-added="refreshQuestionData"
