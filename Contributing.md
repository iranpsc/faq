...
- **Open a new issue**: If your issue hasn't been reported yet, open a new issue in the [Issues section](https://github.com/iranpsc/faq/issues). Be sure to provide as much detail as possible, including:
...
2. **Clone your fork**: Clone the repository to your local machine.
   ```bash
   git clone https://github.com/iranpsc/faq.git
   ```
...
If you have any questions or need assistance, feel free to reach out through [Issues](https://github.com/iranpsc/faq/issues) or contact the maintainers directly.
