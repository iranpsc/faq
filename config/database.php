    ...
    */
    ...
    'connections' => [
        ...
        'faq_main' => [
            ...
            'database' => env('DB_OLD_DATABASE', 'faq_main'),
        ...
        // Secondary read-only connection for WordPress data living in the same database
        'wordpress' => [
            'driver' => 'mysql',
            'url' => env('WP_DB_URL'),
            'host' => env('WP_DB_HOST', '127.0.0.1'),
            'port' => env('WP_DB_PORT', '3306'),
            // Hardcode the known WordPress database name to avoid accidental mismatch with app DB
            'database' => env('WP_DB_DATABASE', 'faq_db'),
